...
#ifndef RTW_HEADER_com_FT60_2020a_h_
#define RTW_HEADER_com_FT60_2020a_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#include "rtw_modelmap.h"
#ifndef com_FT60_2020a_COMMON_INCLUDES_
# define com_FT60_2020a_COMMON_INCLUDES_
...
#endif                                 /* com_FT60_2020a_COMMON_INCLUDES_ */

#include "com_FT60_2020a_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_com_FT60_2020a         RT_MODEL_com_FT60_2020a_T

/* Definition for use in the target main file */
#define com_FT60_2020a_rtModel         RT_MODEL_com_FT60_2020a_T

/* Block signals (default storage) */
typedef struct {
  real_T SignalGenerator;              /* '<Root>/Signal Generator' */
  uint32_T Read[6];                    /* '<Root>/Read ' */
  uint32_T SharedMemoryPack;           /* '<Root>/Shared Memory Pack ' */
  real32_T SharedMemoryUnpack_o1;      /* '<Root>/Shared Memory Unpack ' */
  real32_T SharedMemoryUnpack_o2;      /* '<Root>/Shared Memory Unpack ' */
  real32_T SharedMemoryUnpack_o3;      /* '<Root>/Shared Memory Unpack ' */
  real32_T SharedMemoryUnpack_o4;      /* '<Root>/Shared Memory Unpack ' */
  real32_T SharedMemoryUnpack_o5;      /* '<Root>/Shared Memory Unpack ' */
  real32_T SharedMemoryUnpack_o6;      /* '<Root>/Shared Memory Unpack ' */
  ...
  real32_T CastToSingle4;              /* '<Root>/Cast To Single4' */
  real32_T CastToSingle5;              /* '<Root>/Cast To Single5' */
  real32_T CastToSingle6;              /* '<Root>/Cast To Single6' */
} B_com_FT60_2020a_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  void *Setup_PWORK;                   /* '<Root>/Setup ' */
  void *Read_PWORK;                    /* '<Root>/Read ' */
  void *Write_PWORK;                   /* '<Root>/Write ' */
} DW_com_FT60_2020a_T;

/* Backward compatible GRT Identifiers */
#define rtB                            com_FT60_2020a_B
#define BlockIO                        B_com_FT60_2020a_T
#define rtP                            com_FT60_2020a_P
#define Parameters                     P_com_FT60_2020a_T
#define rtDWork                        com_FT60_2020a_DW
#define D_Work                         DW_com_FT60_2020a_T

/* Parameters (default storage) */
struct P_com_FT60_2020a_T_ {
  ...
  real_T Read_P5;                      /* Expression: id
                                        * Referenced by: '<Root>/Read '
                                        */
  real_T SharedMemoryUnpack_P1_Size[2];
                               /* Computed Parameter: SharedMemoryUnpack_P1_Size
                                * Referenced by: '<Root>/Shared Memory Unpack '
                                */
  real_T SharedMemoryUnpack_P1[6];     /* Expression: get(partition(1),'IType')
                                        * Referenced by: '<Root>/Shared Memory Unpack '
                                        */
  real_T SharedMemoryUnpack_P2_Size[2];
                               /* Computed Parameter: SharedMemoryUnpack_P2_Size
                                * Referenced by: '<Root>/Shared Memory Unpack '
                                */
  real_T SharedMemoryUnpack_P2[12];    /* Expression: get(partition(1),'ISize')
                                        * Referenced by: '<Root>/Shared Memory Unpack '
                                        */
  real_T SharedMemoryUnpack_P3_Size[2];
                               /* Computed Parameter: SharedMemoryUnpack_P3_Size
                                * Referenced by: '<Root>/Shared Memory Unpack '
                                */
  real_T SharedMemoryUnpack_P3[6];   /* Expression: get(partition(1),'IAddress')
                                      * Referenced by: '<Root>/Shared Memory Unpack '
                                      */
  real_T SharedMemoryUnpack_P4_Size[2];
                               /* Computed Parameter: SharedMemoryUnpack_P4_Size
                                * Referenced by: '<Root>/Shared Memory Unpack '
                                */
  real_T SharedMemoryUnpack_P4;        /* Expression: sizeof(partition(1))
                                        * Referenced by: '<Root>/Shared Memory Unpack '
                                        */
  ...
  real_T SignalGenerator_Frequency;    /* Expression: 0.1
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T SharedMemoryPack_P1_Size[2];
                                 /* Computed Parameter: SharedMemoryPack_P1_Size
                                  * Referenced by: '<Root>/Shared Memory Pack '
                                  */
  real_T SharedMemoryPack_P1;          /* Expression: get(partition(1),'IType')
                                        * Referenced by: '<Root>/Shared Memory Pack '
                                        */
  real_T SharedMemoryPack_P2_Size[2];
                                 /* Computed Parameter: SharedMemoryPack_P2_Size
                                  * Referenced by: '<Root>/Shared Memory Pack '
                                  */
  real_T SharedMemoryPack_P2[2];       /* Expression: get(partition(1),'ISize')
                                        * Referenced by: '<Root>/Shared Memory Pack '
                                        */
  real_T SharedMemoryPack_P3_Size[2];
                                 /* Computed Parameter: SharedMemoryPack_P3_Size
                                  * Referenced by: '<Root>/Shared Memory Pack '
                                  */
  real_T SharedMemoryPack_P3;        /* Expression: get(partition(1),'IAddress')
                                      * Referenced by: '<Root>/Shared Memory Pack '
                                      */
  real_T SharedMemoryPack_P4_Size[2];
                                 /* Computed Parameter: SharedMemoryPack_P4_Size
                                  * Referenced by: '<Root>/Shared Memory Pack '
                                  */
  real_T SharedMemoryPack_P4;          /* Expression: sizeof(partition(1))
                                        * Referenced by: '<Root>/Shared Memory Pack '
                                        */
...
struct tag_RTM_com_FT60_2020a_T {
  const char_T *path;
...
extern P_com_FT60_2020a_T com_FT60_2020a_P;

/* Block signals (default storage) */
extern B_com_FT60_2020a_T com_FT60_2020a_B;

/* Block states (default storage) */
extern DW_com_FT60_2020a_T com_FT60_2020a_DW;

/*====================*
 * External functions *
 *====================*/
extern com_FT60_2020a_rtModel *com_FT60_2020a(void);
...
extern RT_MODEL_com_FT60_2020a_T *const com_FT60_2020a_M;
 ...
 * '<Root>' : 'com_FT60_2020a'
 */
#endif                                 /* RTW_HEADER_com_FT60_2020a_h_ */
