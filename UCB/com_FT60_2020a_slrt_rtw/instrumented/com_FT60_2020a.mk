...
MODEL           = com_FT60_2020a
MODULES         = rt_matrx.c rt_printf.c rt_logging.c com_FT60_2020a.c com_FT60_2020a_capi.c com_FT60_2020a_data.c com_FT60_2020a_xcp.c com_FT60_2020a_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c sg_IO901_IO902_read_s.c sg_IO901_IO902_setup_s.c sg_IO901_IO902_write_s.c xpcany2dword.c xpcdword2any.c
MAKEFILE        = com_FT60_2020a.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = com_FT60_2020a_ref.rsp
COMPILER_COMMAND_FILE     = com_FT60_2020a_comp.rsp
...
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\com_FT60_2020a_slrt_rtw}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
{$(START_DIR)\com_FT60_2020a_slrt_rtw}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
