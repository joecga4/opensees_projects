...
MODULES         = rt_matrx.c rt_printf.c rt_logging.c HybridControllerD2D2.c HybridControllerD2D2_capi.c HybridControllerD2D2_data.c HybridControllerD2D2_xcp.c HybridControllerD2D2_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c io901_io902_int_hooks.c rt_logging_mmi.c rtw_modelmap_utils.c PredictorCorrector.c host_timer_x86.c xpc_code_profiling_utility_functions.c sg_IO901_IO902_read_s.c sg_IO901_IO902_setup_s.c sg_IO901_IO902_write_s.c xpcany2dword.c xpcdword2any.c
MAKEFILE        = HybridControllerD2D2.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\joela\Documents\GitHub\joecga4\opensees_projects\UCB
S_FUNCTIONS_LIB = C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\common\libsg\libsg_MSVC160_vc.lib
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = HybridControllerD2D2_ref.rsp
COMPILER_COMMAND_FILE     = HybridControllerD2D2_comp.rsp
...
{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\HybridControllerD2D2_slrt_rtw}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\HybridSimToolbox}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
PredictorCorrector.obj : $(START_DIR)\HybridSimToolbox\PredictorCorrector.c
	@cmd /C "echo ### Compiling $(START_DIR)\HybridSimToolbox\PredictorCorrector.c
	$(CC) $(CFLAGS) $(START_DIR)\HybridSimToolbox\PredictorCorrector.c
sg_IO901_IO902_read_s.obj : C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_read_s.c
	@cmd /C "echo ### Compiling C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_read_s.c
	$(CC) $(CFLAGS) C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_read_s.c
sg_IO901_IO902_setup_s.obj : C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_setup_s.c
	@cmd /C "echo ### Compiling C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_setup_s.c
	$(CC) $(CFLAGS) C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_setup_s.c
sg_IO901_IO902_write_s.obj : C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_write_s.c
	@cmd /C "echo ### Compiling C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_write_s.c
	$(CC) $(CFLAGS) C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory\sg_IO901_IO902_write_s.c
xpcany2dword.obj : "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcany2dword.c"
	@cmd /C "echo ### Compiling "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcany2dword.c"
	$(CC) $(CFLAGS) "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcany2dword.c"
xpcdword2any.obj : "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcdword2any.c"
	@cmd /C "echo ### Compiling "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcdword2any.c"
	$(CC) $(CFLAGS) "C:\Program Files\MATLAB\R2020a\toolbox\rtw\targets\xpc\target\build\xpcblocks\xpcdword2any.c"


{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\9.6.1.1\sg_blocks\sharedmemory}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
...
{$(START_DIR)\HybridControllerD2D2_slrt_rtw}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(START_DIR)\HybridSimToolbox}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
